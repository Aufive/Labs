...
left_comp_ip = '192.168.56.10'
middle_comp_ip = '192.168.56.11'
right_comp_ip = '192.168.56.1'
#порти від одної сторони до іншої
...
def spawn_ball():
    ...
    BALL_X_SPEED = 10#швидкість мяча

#змінення швидкості при відбиванні
def bounce(action):
...
#створення поля (за допомогою Canvas малюється мячик поле ракетки)
